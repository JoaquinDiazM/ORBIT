export const LOCATIONS = Object.freeze([
  ...
  },
  {
    ...
    areaId: "origin",
    kind: "gadget",
    title: "Depósito del Explorador de Campos",
    shortTitle: "Explorador 2D",
    marker: "∇",
    offset: { x: 103, y: -72 },
    ...
    exercise: {
      type: "acknowledge",
      prompt: "Registra el gadget para conservarlo en el menú lateral desde cualquier zona.",
      buttonLabel: "Adquirir explorador",
      explanation: "El Explorador de campos 2D quedó disponible en el menú Gadgets.",
    },
    sources: [],
  },
  {
  ...
  {
    id: "smith-chart-station",
    areaId: "transmission-lines",
    kind: "gadget",
    title: "Estación de la Carta de Smith",
    shortTitle: "Carta de Smith",
    marker: "Γ",
    offset: { x: 94, y: -72 },
    interactionRadius: 72,
    visibility: "visibleWhenAreaUnlocked",
    ...
    sections: [
      {
        ...
        equation: {
          tex: String.raw`z=\frac{Z_L}{Z_0},\qquad \Gamma=\frac{z-1}{z+1}`,
          caption: "Relación entre impedancia normalizada y coeficiente de reflexión.",
        },
        callout: "Contenido provisional: el esqueleto no debe usarse como calculadora ni como sustituto de una resolución analítica.",
      },
    ],
    exercise: {
      type: "acknowledge",
      prompt: "Registra el esqueleto para consultarlo desde el menú Gadgets.",
      buttonLabel: "Adquirir carta",
      explanation: "El esqueleto de la Carta de Smith quedó disponible en el menú Gadgets.",
    },
    sources: [],
  },
  {
