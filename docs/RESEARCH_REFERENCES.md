# Referencias iniciales para investigación y diseño
...
- Steven W. Ellingson, *Electromagnetics I*, LibreTexts.
...
- PhET Interactive Simulations, electricidad y magnetismo.
  - https://phet.colorado.edu/en/simulations/filter?subjects=electricity-and-magnets&type=html
- National High Magnetic Field Laboratory, Magnet Academy.
  - https://nationalmaglab.org/magnet-academy/

## Historia y tecnología

- Engineering and Technology History Wiki, IEEE History Center.
  - https://ethw.org/
- Smithsonian Institution, colecciones de historia de electricidad, comunicaciones e instrumentación.
  - https://www.si.edu/
- NASA, comunicaciones espaciales.
  - https://www.nasa.gov/communicating-with-missions/
- ALMA Observatory, funcionamiento e instrumentación.
  - https://www.almaobservatory.org/en/about-alma/how-alma-works/

## Diseño pedagógico

Buscar y revisar literatura sobre:

- ejemplos resueltos y *fading*;
- autoexplicación en resolución de problemas de física;
- aprendizaje multimedia y coherencia;
- gamificación en educación superior;
- historia y filosofía de la ciencia en la enseñanza del electromagnetismo;
- evaluación de transferencia, no solo recuerdo.

Antes de incorporar una conclusión pedagógica al diseño, registrar:
